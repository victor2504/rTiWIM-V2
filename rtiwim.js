...
class Tiwim {
  ...
  init() {
    ...
    <div class="logo-container">
            <img id="logo" src="img/ls.png" class="logo">
        </div>
        ...
        <div class="item" id="undo-action">
           ...
           <div class="item" id="undo-action">
            ...
            <div class="item" id="cancelar-action">
  ...
  //menu central
    ...
    $j('#tiwim-tool-area #save-action').click(function () {//botão salvar
      var r=confirm("Deseja realmente finalizar?"); 
      if (r==true) { 
    ...
    $j('#tiwim-tool-area #cancelar-action').click(function () {//botão Voltar
      var c=confirm("Deseja realmente voltar?"); 
      if (c==true) { 
  ...
  download() {
    ...
    let finalFileName = 'rtiwim_' + window.location.hostname + '_' + actualTimestamp + '.txt';
    let obj = {
    ...
    window.location = "http://rtiwim.com.br/cad_feedback.php?log="+txt;
